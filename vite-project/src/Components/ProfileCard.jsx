  ...
  return (
    <div className='bg-white rounded-lg shadow-md p-6 mb-6'>
        <div className='flex items-center mb-4'>
            <div className='w-15 h-15 bg-gradient-to-r from-blue-700 to-blue-300 rounded-full flex items-center justify-center text-white text-3xl font-bold mr-2'></div>
            <div>
